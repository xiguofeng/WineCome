...
import static com.xgf.winecome.ui.view.materialmenu.MaterialMenuDrawable.DEFAULT_COLOR;
...
public class MaterialMenuView extends View implements MaterialMenu {
	...
	private void init(Context context, AttributeSet attributeSet) {
		...
		try {
			...
			boolean rtlEnabled = attr.getBoolean(
					R.styleable.MaterialMenuView_mm_rtlEnabled, false);

			drawable = new MaterialMenuDrawable(context, color, stroke, scale,
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
			widthMeasureSpec = MeasureSpec.makeMeasureSpec(
					drawable.getIntrinsicWidth() + paddingX,
					MeasureSpec.EXACTLY);
	...
	private void adjustDrawablePadding() {
		if (drawable != null) {
			drawable.setBounds(0, 0, drawable.getIntrinsicWidth()
					...
					drawable.getIntrinsicHeight() + getPaddingTop()
							+ getPaddingBottom());
		}
	}
