...
public class NewMainActivity extends Activity implements OnClickListener {
	...
	private CustomListView mLeftLv;
	private CustomListView mRightLv;
	...
	private void initView() {
		mSv = (ScrollView) findViewById(R.id.main_sv);

		View content = LayoutInflater.from(this).inflate(R.layout.main_content,
				null);

		if (null != content) {
			initListView(content);
			initCircleimage(content);
			mSv.addView(content);
		}
	...
	private void initListView(View content) {
		mLeftLv = (CustomListView) content.findViewById(R.id.main_left_lv);
		mRightLv = (CustomListView) content.findViewById(R.id.main_right_lv);

	}

	private void initCircleimage(View content) {
		mViewFlow = (ViewFlow) content.findViewById(R.id.main_viewflow);
		mIndic = (CircleFlowIndicator) content
				.findViewById(R.id.main_viewflowindic);
