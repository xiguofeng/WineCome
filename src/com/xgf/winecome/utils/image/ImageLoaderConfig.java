...
public class ImageLoaderConfig {
	...
	public static DisplayImageOptions initDisplayOptions(boolean isShowDefault) {
		...
		if (isShowDefault) {
			// 默认显示的图片
			displayImageOptionsBuilder.showStubImage(R.drawable.img_null);
			// 地址为空的默认显示图片
			displayImageOptionsBuilder.showImageForEmptyUri(R.drawable.img_null);
			// 加载失败的显示图片
			displayImageOptionsBuilder.showImageOnFail(R.drawable.img_null);
		}
		// 开启内存缓存
	...
	public static DisplayImageOptions initDisplayOptions(int targetWidth,
		...
		if (isShowDefault) {
			...
			displayImageOptionsBuilder
					.showImageForEmptyUri(R.drawable.img_null);
			// 加载失败的显示图片
			displayImageOptionsBuilder.showImageOnFail(R.drawable.img_null);
		}
		// 开启内存缓存
